...
public class ItemsHandlerTest {
  ...
  public void test_findById() {
    Flux<Item> mono =  webTestClient.get().uri(ItemConstants.ITEM_FUNCTIONAL_ENDPOINT_V1 + "/{id}", "ABC")
        .exchange()
        .expectStatus().isOk()
        .expectHeader().contentType(MediaType.APPLICATION_JSON)
        .returnResult(Item.class)
  ...
  public void test_findById_approach2() {
    webTestClient.get().uri(ItemConstants.ITEM_FUNCTIONAL_ENDPOINT_V1 + "/{id}", "ABC")
        .exchange()
        .expectStatus().isOk()
        .expectHeader().contentType(MediaType.APPLICATION_JSON)
        .expectBody()
  ...
  public void test_createItem_approach2() {
    ...
    Flux<Item> itemFlux = webTestClient.post().uri(ItemConstants.ITEM_FUNCTIONAL_ENDPOINT_V1)
        .contentType(MediaType.APPLICATION_JSON)
  ...
  public void test_deleteItem() {
    ...
    webTestClient.delete().uri(ItemConstants.ITEM_FUNCTIONAL_ENDPOINT_V1 + "/{id}", "ABC")
  ...
  public void test_updateItem() {
    ...
    webTestClient.put().uri(ItemConstants.ITEM_FUNCTIONAL_ENDPOINT_V1 + "/{id}", "ABC")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(item), Item.class)
        .accept(MediaType.APPLICATION_JSON)
        .exchange()
  ...
  public void test_updateItem_approach2() {
    ...
    Flux<Item> itemFlux = webTestClient.put().uri(ItemConstants.ITEM_FUNCTIONAL_ENDPOINT_V1 + "/{id}", "ABC")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(item), Item.class)
        .accept(MediaType.APPLICATION_JSON)
        .exchange()
  ...
  @Test
  public void test_functionalExceptionHandling() {

    webTestClient.get().uri(ItemConstants.ITEM_FUNCTIONAL_ENDPOINT_V1 + "/runtime/exception")
        .exchange()
        .expectStatus().is5xxServerError()
        .expectBody(String.class)
        .isEqualTo("Runtime exception functional handler.");
  }

  @Test
  public void test_functionalExceptionHandling_approach2() {

    Flux<String> stringFlux = webTestClient.get().uri(ItemConstants.ITEM_FUNCTIONAL_ENDPOINT_V1 + "/runtime/exception")
        .exchange()
        .expectStatus().is5xxServerError()
        .returnResult(String.class)
        .getResponseBody();

    StepVerifier.create(stringFlux.log("Functional Exception Handling"))
        .expectSubscription()
        .expectNext("Runtime exception functional handler.")
        .expectComplete();
  }
